import { getLayout } from "@/layouts/ProjectLayout";
...
function ProjectUser() {
	...
	return teams.map((team, i) => (
		<>
			<section key={team.id} className="pb-8">
			...
			{i !== teams.length - 1 && <hr className="pb-8 opacity-50" />}
		</>
	));
}
